...
public class FetcherUtils {
	...
	public static final UserAgent USER_AGENT = new UserAgent(conf.get("agent.name", "SentiMAP"), conf.get("agent.email", "info@tokenizer.ca"), conf.get(
			"agent.url", "http://www.tokenizer.ca"));
