...
public class MetricsCache {
  ...
  /**
   * We need this... otherwise data can become wrong: 10000 URLs added from site
   * maps, although the same 1000 URLs were attempted to add 9 more times.
   * "Reset" will zero all counters on a Task Start/Restart.
   * 
