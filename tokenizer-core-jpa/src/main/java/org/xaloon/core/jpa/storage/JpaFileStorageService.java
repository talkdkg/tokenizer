...
public class JpaFileStorageService implements FileStorageService {
    ...
    public byte[] getByteArrayByIdentifier(String identifier) {
        ...
        JpaFileStorage jfs = persistenceServices.find(JpaFileStorage.class, Long.valueOf(identifier));// TODO fix save
                                                                                                      // convert
    ...
    public boolean delete(String uniqueIdentifier) {
        ...
        JpaFileStorage jfs = persistenceServices.find(JpaFileStorage.class, Long.valueOf(uniqueIdentifier));// TODO fix
                                                                                                            // save
                                                                                                            // convert
        if (jfs == null) {
            return false;
    ...
    public KeyValue<String, String> storeFile(FileDescriptor fileDescriptor, InputStreamContainer inputStreamContainer,
        ...
        try {
            ...
            String path = Configuration.get().getFileDescriptorAbsolutePathStrategy()
                    .generateAbsolutePath(fileDescriptor, true, "");
