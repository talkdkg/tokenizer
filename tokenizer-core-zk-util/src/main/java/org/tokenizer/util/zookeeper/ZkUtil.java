...
public class ZkUtil {
    ...
    public static ZooKeeperItf connect(final String connectString, final int sessionTimeout) throws ZkConnectException {
        ...
        if (!connected) {
            ...
            Thread.dumpStack();
            zooKeeper.close();
            throw new ZkConnectException("Failed to connect with Zookeeper @ '" + connectString + "' within timeout "
                    + sessionTimeout);
        }
        return zooKeeper;
    }

    public static void createPath(final ZooKeeperItf zk, final String path) throws InterruptedException,
            KeeperException {
     ...
     * 
     * <p>
     * The supplied data is used for the last node in the path. If the path already exists, the data is updated if
     * necessary.
     */
     ...
     * 
     * <p>
     * The supplied data is used for the last node in the path. The path must already exist. It is not checked if the
     * data is changed or not. This will cause the version of the node to be increased.
     * <p>
