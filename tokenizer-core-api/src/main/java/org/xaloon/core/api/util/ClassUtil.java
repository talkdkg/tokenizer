...
public class ClassUtil {
    ...
    /**
     * Returns annotation for specified class. if current class does not have such annotation then super class is
     * checked.
     * 
     * @param <A>
     * 
    ...
    /**
     * Returns class which has specified annotation. If current class does not have one then check is processed on super
     * class.
     * 
     * @param <A>
     * 
     ...
     */
    public static <A extends Annotation> Class<?> getClassByAnnottation(Class<?> classForAnnotation,
     ...
     * @throws CreateClassInstanceException
     */
    public static Object newInstance(Class<?> classToCreate, Class<?>[] parameterTypes, Object[] parameterValues)
            throws CreateClassInstanceException {
        try {
            ...
            throw new CreateClassInstanceException("Could not create instance for class '" + classToCreate
                    + "' with parameters '" + Arrays.toString(parameterValues) + "'");
