...
public class TransliterateUtils {
    private static final String[] charsTransliterateFrom = new String[] { "Ą", "Č", "Ę", "Ė", "Į", "Š", "Ų", "Ū", "Ž",
            "ą", "č", "ę", "ė", "į", "š", "ų", "ū", "ž", "А", "а", "Б", "б", "В", "в", "Г", "г", "Д", "д", "Е", "е",
            "Ё", "ё", "Ж", "ж", "З", "з", "И", "и", "Й", "й", "К", "к", "Л", "л", "М", "м", "Н", "н", "О", "о", "П",
            "п", "Р", "р", "С", "с", "Т", "т", "У", "у", "Ф", "ф", "Х", "х", "Ц", "ц", "Ч", "ч", "Ш", "ш", "Щ", "щ",
            "Ъ", "ъ", "Ы", "ы", "Ь", "ь", "Э", "э", "Ю", "ю", "Я", "я" };
    private static final String[] charsTransliterateTo = new String[] { "A", "C", "E", "E", "I", "S", "U", "U", "Z",
            "a", "c", "e", "e", "i", "s", "u", "u", "z", "A", "a", "B", "b", "V", "v", "G", "g", "D", "d", "E", "e",
            "Yo", "yo", "Zh", "zh", "Z", "z", "I", "i", "J", "j", "K", "k", "L", "l", "M", "m", "N", "n", "O", "o",
            "P", "p", "R", "r", "S", "s", "T", "t", "U", "u", "F", "f", "H", "h", "Ts", "ts", "Ch", "ch", "Sh", "sh",
            "Sch", "sch", "'", "'", "I", "i", "'", "'", "E", "e", "Yu", "yu", "Ya", "ya" };
