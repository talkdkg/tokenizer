...
public interface ExecutorModel {
   ...
   * listener will receive events for all updates that happened after the
   * returned snapshot of the tasks.
   * <p>
  ...
  TaskInfoBean getTask(String name) throws TaskNotFoundException;
