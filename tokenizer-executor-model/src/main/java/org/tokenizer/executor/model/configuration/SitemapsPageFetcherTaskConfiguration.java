...
public class SitemapsPageFetcherTaskConfiguration extends AbstractFetcherTaskConfiguration {

    private static final long serialVersionUID = 1L;

    @Override
    public String getImplementationName() {
        return SitemapsPageFetcherTaskConfiguration.class.getSimpleName();
    }
