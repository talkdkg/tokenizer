...
import org.tokenizer.wicket.page.IndexPage;
import org.tokenizer.wicket.temp.TemporaryFacade;
...
public class WicketApplication extends AuthenticatedWebApplication {
	...
	protected void onBeforeMountPackage(List<String> mountingPackages) {
		mountingPackages.add("org.tokenizer.wicket");
	}
