...
public class UpdateTaskCli extends BaseAdminCli {
    ...
    public int run(final CommandLine cmd) throws Exception {
        ...
        try {
            ...
            if (taskConfiguration != null && !taskConfiguration.equals(task.getTaskConfiguration())) {
                task.setTaskConfiguration(taskConfiguration);
                changes = true;
            }
            if (generalState != null && generalState != task.getTaskConfiguration().getGeneralState()) {
            ...
            if (changes) {
                ...
                System.out.println("Task already matches the specified settings, did not update it.");
            }
        } finally {
            ...
            // deletion.
            boolean ignoreMissing = generalState != null && generalState == TaskGeneralState.DELETE_REQUESTED;
