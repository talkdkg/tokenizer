...
public class TokenizerClient {
    ...
    private static final String HOST = TokenizerConfig.getProperties()
            .getProperty("tokenizer.thrift.host", "108.175.12.244");
    private static final int PORT = TokenizerConfig.getInt(
            "tokenizer.thrift.port", 32123);
