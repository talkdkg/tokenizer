...
public class PersonContainer extends BeanItemContainer<Person> implements
  ...
  public static final Object[] NATURAL_COL_ORDER = new Object[] {"firstName",
      "lastName", "email", "phoneNumber", "streetAddress", "postalCode", "city"};
  ...
  public static final String[] COL_HEADERS_ENGLISH = new String[] {
      "First name", "Last name", "Email", "Phone number", "Street Address",
      "Postal Code", "City"};
  ...
  public static PersonContainer createWithTestData() {
    ...
    final String streets[] = {"4215 Blandit Av.", "452-8121 Sem Ave",
        ...
        "P.O. Box 859, 7661 Auctor St.", "2873 Nonummy Av.", "7342 Mi, Avenue",
        ...
        "2870 Vestibulum St.", "Ap #722 Aenean Avenue", "446-968 Augue Ave",
